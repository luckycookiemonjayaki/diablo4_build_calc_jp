...
barbarianData["Base"] = {
	"Bash": {
		connections: [ "Base", "Enhanced Bash" ],
		description: `怒気生成量: {#}
Lucky Hit Chance: {#}%
Bash the enemy with your weapon, dealing {#}% ダメージ. After bashing enemies {#} times, your next Bash will Stun for {#} seconds, this increases to {#} seconds if using a Two-Handed weapon.`,
		id: 0,
		maxPoints: 5,
	...
	"ランジング・ストライク": {
		connections: [ "Base", "Enhanced ランジング・ストライク" ],
		description: `怒気生成量: {#}
Lucky Hit Chance: {#}%
前方に突進して敵を攻撃し、 {#}% のダメージを与える。`,
		id: 4,
		maxPoints: 5,
		values: [ "9", "50", "30" ],
		x: -557.739,
	...
	"Enhanced ランジング・ストライク": {
		baseSkill: "ランジング・ストライク",
		connections: [ "ランジング・ストライク", "Combat ランジング・ストライク", "Battle ランジング・ストライク" ],
		description: `ランジング・ストライク deals x{#}% increased ダメージ and Heals you for {#}% Maximum Life ({#}) when it ダメージs a Healthy enemy.`,
		id: 5,
		maxPoints: 1,
		values: [ "30", "2", "" ],
		x: -687.389,
	...
	"Combat ランジング・ストライク": {
		baseSkill: "ランジング・ストライク",
		connections: [ "Enhanced ランジング・ストライク" ],
		description: `Critical Strikes with ランジング・ストライク grant you Berserking for {#} seconds.`,
		id: 6,
		maxPoints: 1,
		values: [ "1.5" ],
		x: -630.918,
	...
	"Battle ランジング・ストライク": {
		baseSkill: "ランジング・ストライク",
		connections: [ "Enhanced ランジング・ストライク" ],
		description: `ランジング・ストライク also inflicts {#}% Bleeding ダメージ over {#} seconds.`,
		id: 7,
		maxPoints: 1,
		values: [ "20", "5" ],
		x: -923.284,
	...
	"Frenzy": {
		connections: [ "Base", "Enhanced Frenzy" ],
		description: `怒気生成量: {#}
Lucky Hit Chance: {#}%
Unleash a rapid flurry of blows, dealing {#}% ダメージ with each pair of hits.
...
If Frenzy hits an enemy, its Attack Speed is increased by +{#}% for {#} seconds, up to +{#}%.`,
	...
	"Combat Frenzy": {
		baseSkill: "Frenzy",
		connections: [ "Enhanced Frenzy" ],
		description: `You gain {#}% ダメージ Reduction for each stack of Frenzy you currently have.`,
		id: 11,
		maxPoints: 1,
		values: [ "8" ],
		x: 145.246,
	...
	"Flay": {
		connections: [ "Base", "Enhanced Flay" ],
		description: `怒気生成量: {#}
Lucky Hit Chance: {#}%
Flay the enemy, dealing {#}% ダメージ and inflicting {#}% Bleeding ダメージ over {#} seconds.`,
		id: 12,
		maxPoints: 5,
		values: [ "9", "50", "5", "36", "5" ],
		x: 561.736,
	...
	"Battle Flay": {
		...
		description: `When Flay deals direct ダメージ to an enemy, they take x{#}% increased Bleeding ダメージ from you for the next {#} seconds.`,
		id: 14,
		maxPoints: 1,
		values: [ "10", "3" ],
		x: 638.801,
	...
	"Combat Flay": {
		baseSkill: "Flay",
		connections: [ "Enhanced Flay" ],
		description: `When Flay deals direct ダメージ to an enemy, you gain {#}% ダメージ Reduction and {#} Thorns for {#} seconds. This stacks up to {#} times.`,
		id: 15,
		maxPoints: 1,
		values: [ "3", "", "3", "4" ],
		x: 946.316,
...
Lucky Hit Chance: {#}%
Slam your hammer down with the fury of the Ancients, dealing {#}% ダメージ to a concentrated area.`,
		id: 16,
		maxPoints: 5,
		values: [ "35", "40", "56" ],
		x: -418.74,
	...
	"Enhanced Hammer of the Ancients": {
		...
		description: `Gain x{#}% more Fury for {#} seconds for each enemy ダメージd by Hammer of the Ancients, stacking up to {#} times.`,
		id: 17,
		maxPoints: 1,
		values: [ "3", "5", "10" ],
		x: -654.995,
	...
	"Violent Hammer of the Ancients": {
		...
		description: `After Overpowering with Hammer of the Ancients, you deal x{#}% more ダメージ for {#} seconds.`,
		id: 18,
		maxPoints: 1,
		values: [ "30", "2.5" ],
		x: -918.03,
	...
	"Furious Hammer of the Ancients": {
		baseSkill: "Hammer of the Ancients",
		connections: [ "Enhanced Hammer of the Ancients" ],
		description: `Hammer of the Ancients deals x{#}% additional ダメージ for each point of Fury you had when using it.`,
		id: 19,
		maxPoints: 1,
		values: [ "1" ],
		x: -661.27,
	...
	"Upheaval": {
		...
		description: `Fury Cost: {#}
Lucky Hit Chance: {#}%
Tear into the ground with your weapon and fling debris forward, dealing {#}% ダメージ.`,
		id: 20,
		maxPoints: 5,
		values: [ "40", "20", "70" ],
		x: -584.54,
	...
	"Enhanced Upheaval": {
		...
		description: `Upheaval has a {#}% chance to Stun all enemies it ダメージs for {#} seconds.`,
		id: 21,
		maxPoints: 1,
		values: [ "20", "2.5" ],
		x: -903.275,
	...
	"Violent Upheaval": {
		...
		description: `If Upheaval ダメージs at least {#} enemies, you gain Berserking for {#} seconds, increased to {#} seconds if it ダメージs at least {#} enemies.`,
		id: 22,
		maxPoints: 1,
		values: [ "2", "2", "3", "4" ],
		x: -1169.22,
	...
	"Furious Upheaval": {
		baseSkill: "Upheaval",
		connections: [ "Enhanced Upheaval" ],
		description: `Dealing direct ダメージ to an enemy with a Skill that is not Upheaval causes your next cast of Upheaval to deal x{#}% increased ダメージ, stacking up to {#} times.`,
		id: 23,
		maxPoints: 1,
		values: [ "8", "10" ],
		x: -1021.685,
	...
	"Double Swing": {
		...
		description: `Fury Cost: {#}
Lucky Hit Chance: {#}%
Sweep your weapons from opposite directions, dealing {#}% ダメージ with each weapon. Enemies caught in the center are ダメージd by both.`,
		id: 24,
		maxPoints: 5,
		values: [ "25", "30", "36" ],
		x: -271.825,
	...
	"Enhanced Double Swing": {
		...
		description: `If Double Swing ダメージs a Stunned or Knocked Down enemy, gain {#} Fury.`,
		id: 25,
		maxPoints: 1,
		values: [ "15" ],
		x: -458.17,
	...
	"Rend": {
		...
		description: `Fury Cost: {#}
Lucky Hit Chance: {#}%
Cleave enemies in front of you, dealing {#}% ダメージ and inflicting {#}% Bleeding ダメージ over {#} seconds.`,
		id: 29,
		maxPoints: 5,
	...
	"Enhanced Rend": {
		...
		description: `Dealing direct ダメージ with Rend extends the duration of Vulnerable on enemies by {#} seconds.`,
		id: 30,
		maxPoints: 1,
		values: [ "2" ],
		x: 903.276,
	...
	"Violent Rend": {
		...
		description: `Rend deals x{#}% increased ダメージ to Vulnerable enemies.`,
		id: 31,
		maxPoints: 1,
		values: [ "12" ],
		x: 1115.578,
	...
	"Furious Rend": {
		baseSkill: "Rend",
		connections: [ "Enhanced Rend" ],
		description: `Direct ダメージ with Rend grants {#} Fury per enemy hit, up to a maximum of {#} Fury.`,
		id: 32,
		maxPoints: 1,
		values: [ "4", "20" ],
		x: 1113.346,
...
Lucky Hit Chance: {#}%
Rapidly attack surrounding enemies for {#}% ダメージ.`,
		id: 33,
		maxPoints: 5,
		values: [ "20", "20", "12" ],
		x: -0.76,
	...
	"Enhanced Whirlwind": {
		...
		description: `Gain {#} Fury each time Whirlwind deals direct ダメージ to an enemy, or {#} Fury against Elite enemies.`,
		id: 34,
		maxPoints: 1,
		values: [ "1", "3" ],
		x: 0.875,
	...
	"Furious Whirlwind": {
		...
		description: `While using a Slashing weapon, Whirlwind also inflicts {#}% of its Base ダメージ as Bleeding ダメージ over {#} seconds.`,
		id: 35,
		maxPoints: 1,
		values: [ "20", "5" ],
		x: 157.99,
	...
	"Violent Whirlwind": {
		baseSkill: "Whirlwind",
		connections: [ "Enhanced Whirlwind" ],
		description: `After using Whirlwind for {#} seconds, Whirlwind deals x{#}% increased ダメージ until it is cancelled.`,
		id: 36,
		maxPoints: 1,
		values: [ "2", "30" ],
		x: -154.095,
	...
	"Endless Fury": {
		connections: [ "Core" ],
		description: `Base Skills generate x{#}% more Fury when using Two-Handed weapons.`,
		id: 37,
		maxPoints: 3,
		values: [ "{5/10/15}" ],
		x: 176.84,
...
Taunt Nearby enemies and gain {#}% ダメージ Reduction for {#} seconds.`,
		id: 38,
		maxPoints: 5,
	...
	"Tactical Challenging Shout": {
		baseSkill: "Challenging Shout",
		connections: [ "Enhanced Challenging Shout" ],
		description: `While Challenging Shout is active, you gain {#} Fury each time you take ダメージ.`,
		id: 41,
		maxPoints: 1,
		values: [ "3" ],
		x: -169.118,
...
Steel yourself, gaining a Barrier that absorbs {#}% of your missing Life for {#} seconds.`,
	...
	"Tough as Nails": {
		...
		description: `Increase your Thorns by +{#}%. When enemies hit you, they take an additional {#}% of your Thorns as Bleeding ダメージ over {#} seconds.`,
		id: 47,
		maxPoints: 3,
		values: [ "{20/40/60}", "1", "5" ],
		x: 495.69,
	...
	"Ground Stomp": {
		...
		description: `Cooldown: {#} seconds
Lucky Hit Chance: {#}%
Smash the ground, dealing {#}% ダメージ and Stunning surrounding enemies for {#} seconds.`,
		id: 48,
		maxPoints: 5,
		values: [ "16", "33", "10", "3" ],
		x: 4.675,
	...
	"Strategic Ground Stomp": {
		baseSkill: "Ground Stomp",
		connections: [ "Enhanced Ground Stomp" ],
		description: `Reduce the Cooldown of your Ultimate Skill by {#} second for each enemy ダメージd by Ground Stomp.`,
		id: 51,
		maxPoints: 1,
		values: [ "1" ],
		x: 147.985,
...
Bellow a rallying cry, increasing your Movement Speed by +{#}% and Resource Generation by x{#}% for {#} seconds, and Nearby allies for {#} seconds.`,
	...
	"Strategic Rallying Cry": {
		...
		description: `Rallying Cry grants you {#}% Base Life ({#}) as Fortify. While Rallying Cry is active, you gain an additional {#}% Base Life ({#}) as Fortify each time you take or deal direct ダメージ.`,
		id: 54,
		maxPoints: 1,
		values: [ "10", "", "2", "" ],
		x: 1169.235,
	...
	"Martial Vigor": {
		...
		description: `ダメージ Reduction against Elites is increased by {#}%.`,
		id: 57,
		maxPoints: 3,
		values: [ "{4/8/12}" ],
		x: 495.85,
...
barbarianData["Brawling"] = {
	"Charge": {
		...
		description: `Cooldown: {#} seconds
Lucky Hit Chance: {#}%
Become Unstoppable and rush forward, pushing enemies with you then swinging through them for {#}% ダメージ and Knocking them Back.`,
		id: 58,
		maxPoints: 5,
		values: [ "17", "33", "25" ],
		x: -652.69,
	...
	"Enhanced Charge": {
		...
		description: `Enemies who are Knocked Back into terrain by Charge take {#}% ダメージ and are Stunned for {#} seconds.`,
		id: 59,
		maxPoints: 1,
		values: [ "15", "3" ],
		x: -1012.34,
	...
	"War Cry": {
		...
		description: `Cooldown: {#} seconds
Bellow a mighty war cry, increasing your ダメージ dealt by x{#}% for {#} seconds, and Nearby allies for {#} seconds.`,
		id: 62,
		maxPoints: 5,
	...
	"Power War Cry": {
		...
		description: `If at least {#} enemies are Nearby when you cast War Cry, your ダメージ bonus is increased to x{#}%.`,
		id: 64,
		maxPoints: 1,
		values: [ "6", "30" ],
		x: -972.08,
	...
	"Guttural Yell": {
		connections: [ "Booming Voice" ],
		description: `Your Shout Skills cause enemies to deal {#}% less ダメージ for {#} seconds.`,
		id: 68,
		maxPoints: 3,
		values: [ "{8/16/24}", "5" ],
		x: -942.85,
	...
	"Leap": {
		...
		description: `Cooldown: {#} seconds
Lucky Hit Chance: {#}%
Leap forward and then slam down, dealing {#}% ダメージ and Knocking Back surrounding enemies on impact.`,
		id: 69,
		maxPoints: 5,
		values: [ "17", "33", "33" ],
		x: -402.935,
	...
	"Enhanced Leap": {
		...
		description: `If Leap doesn't ダメージ any enemies, its Cooldown is reduced by {#} seconds.`,
		id: 70,
		maxPoints: 1,
		values: [ "4" ],
		x: -623.595,
	...
	"Mighty Leap": {
		...
		description: `Enemies ダメージd by Leap are Slowed by {#}% for {#} seconds.`,
		id: 71,
		maxPoints: 1,
		values: [ "50", "5" ],
		x: -623.425,
	...
	"Power Leap": {
		baseSkill: "Leap",
		connections: [ "Enhanced Leap" ],
		description: `If Leap ダメージs at least one enemy, gain {#} Fury.`,
		id: 72,
		maxPoints: 1,
		values: [ "40" ],
		x: -893.655,
...
Lucky Hit Chance: {#}%
Throw a powerful kick that deals {#}% ダメージ and Knocks Back enemies in front of you. Enemies who are Knocked Back into terrain take an additional {#}% ダメージ and are Stunned for {#} seconds.`,
		id: 73,
		maxPoints: 5,
	...
	"Mighty Kick": {
		...
		description: `Kicked enemies deal {#}% ダメージ to enemies they collide with while being Knocked Back. Enemies ダメージd this way are Knocked Down for {#} seconds.`,
		id: 75,
		maxPoints: 1,
		values: [ "54", "2" ],
		x: -174.78,
	...
	"Power Kick": {
		baseSkill: "Kick",
		connections: [ "Enhanced Kick" ],
		description: `If Kick ダメージs an enemy, it consumes all of your Fury and deals an additional {#}% ダメージ per {#} Fury spent. Kick no longer Knocks Back enemies.`,
		id: 76,
		maxPoints: 1,
		values: [ "20", "10" ],
		x: 172.96,
	...
	"Aggressive Resistance": {
		...
		description: `Gain {#}% ダメージ Reduction while Berserking.`,
		id: 77,
		maxPoints: 3,
		values: [ "{4/8/12}" ],
		x: -0.385,
	...
	"Battle Fervor": {
		connections: [ "Aggressive Resistance" ],
		description: `When a Brawling Skill ダメージs at least one enemy, gain Berserking for {#} seconds.`,
		id: 125,
		maxPoints: 3,
		values: [ "{1/2/3}" ],
		x: -170.435,
...
Charge Cooldown: {#} seconds
Lucky Hit Chance: {#}%
Throw out a trio of chains that deal {#}% ダメージ and Pull In enemies.`,
		id: 82,
		maxPoints: 5,
		values: [ "2", "11", "25", "23" ],
		x: 416.495,
	...
	"Fighter's Steel Grasp": {
		baseSkill: "Steel Grasp",
		connections: [ "Enhanced Steel Grasp" ],
		description: `If Steel Grasp ダメージs an enemy, gain Berserking for {#} seconds.`,
		id: 85,
		maxPoints: 1,
		values: [ "2" ],
		x: 945.955,
	...
	"Thick Skin": {
		...
		description: `Each time you take direct ダメージ gain {#}% Base Life ({#}) as Fortify.`,
		id: 86,
		maxPoints: 3,
		values: [ "0.4", "" ],
		x: 0.22,
	...
	"Counteroffensive": {
		...
		description: `While you have Fortify for over {#}% of your Maximum Life, you deal x{#}% increased ダメージ.`,
		id: 87,
		maxPoints: 3,
		values: [ "50", "{5/10/15}" ],
		x: 156.02,
	...
	"Defensive Stance": {
		connections: [ "Thick Skin" ],
		description: `Increase the ダメージ Reduction gained while you are Fortified by an additional {#}%.`,
		id: 126,
		maxPoints: 3,
		values: [ "{3/6/9}" ],
		x: -158.837,
...
Cooldown: {#} seconds
Lucky Hit Chance: {#}%
Attempt a killing strike, dealing {#}% ダメージ to enemies in front of you.
...
If this kills an enemy, its Cooldown is reset.`,
	...
	"Enhanced Death Blow": {
		...
		description: `Death Blow deals x{#}% increased ダメージ to Bosses.`,
		id: 90,
		maxPoints: 1,
		values: [ "100" ],
		x: -923.053,
	...
	"Warrior's Death Blow": {
		...
		description: `If Death Blow ダメージs at least one enemy, gain Berserking for {#} seconds.`,
		id: 91,
		maxPoints: 1,
		values: [ "3" ],
		x: -1133.18,
	...
	"Fighter's Death Blow": {
		baseSkill: "Death Blow",
		connections: [ "Enhanced Death Blow" ],
		description: `If Death Blow ダメージs at least one enemy, gain {#} Fury.`,
		id: 92,
		maxPoints: 1,
		values: [ "20" ],
		x: -1132.87,
	...
	"Pit Fighter": {
		...
		description: `You deal x{#}% increased ダメージ to Close enemies and gain {#}% Distant ダメージ Reduction.`,
		id: 93,
		maxPoints: 3,
		values: [ "{3/6/9}", "{2/4/6}" ],
		x: 0.37,
	...
	"Slaying Strike": {
		...
		description: `You deal x{#}% increased ダメージ against Injured enemies.`,
		id: 94,
		maxPoints: 3,
		values: [ "{8/15/23}" ],
		x: 203.61,
	...
	"Expose Vulnerability": {
		...
		description: `Dealing direct ダメージ with a Weapon Mastery skill causes your next Core Skill to make enemies Vulnerable for {#} seconds.`,
		id: 95,
		maxPoints: 3,
		values: [ "{1/2/3}" ],
		x: -0.085,
...
Charge Cooldown: {#} seconds
Lucky Hit Chance: {#}%
Skewer enemies in front of you, dealing {#}% ダメージ, then rip your weapon out, damaging enemies for their total Bleeding amount and removing all Bleeding ダメージ from them.`,
		id: 97,
		maxPoints: 5,
		values: [ "10", "", "", "50", "13" ],
		x: 408.44,
	...
	"Enhanced Rupture": {
		...
		description: `Ripping your weapon out of enemies during Rupture causes an explosion that deals {#}% Bleeding ダメージ over {#} seconds.`,
		id: 98,
		maxPoints: 1,
		values: [ "30", "5" ],
		x: 672.735,
	...
	"Cut to the Bone": {
		...
		description: `Your Bleeding effects deal x{#}% increased ダメージ to Vulnerable enemies.`,
		id: 102,
		maxPoints: 3,
		values: [ "{6/12/18}" ],
		x: 856.285,
...
Call upon 3 Ancients to aid you in battle for {#} seconds.
 Korlic leaps at enemies, dealing {#}% ダメージ and swings his weapons in a frenzy, dealing {#}% ダメージ per hit.
 Talic spins in a whirlwind rapidly attacking enemies for {#}% ダメージ.
 Madawc upheaves the ground, dealing {#}% ダメージ.`,
		id: 103,
		maxPoints: 1,
	...
	"Prime Call of the Ancients": {
		...
		description: `While Call of the Ancients is active, gain +{#}% bonus Attack Speed and x{#}% increased ダメージ.`,
		id: 104,
		maxPoints: 1,
		values: [ "10", "10" ],
		x: 2.05,
...
Korlic: You gain 10 Fury each time Korlic ダメージs an enemy with his Frenzy.
Talic: Enemies are Slowed by {#}% for {#} second when ダメージd by his Whirlwind.
...
Activate three times to attach chains to each of your weapons and perform an attack:
 First your Two-Handed Bludgeoning weapon slams into the ground, dealing {#}% ダメージ and Stunning enemies for {#} seconds.
 Second your Two-Handed Slashing weapon swipes in front of you, dealing {#}% ダメージ and inflicting {#}% Bleeding ダメージ over {#} seconds.
 Third your Dual Wield weapons swing around you, dealing {#}% ダメージ per hit.`,
		id: 106,
		maxPoints: 1,
	...
	"Prime Iron Maelstrom": {
		...
		description: `Iron Maelstrom gains +{#}% increased Critical Strike Chance and deals x{#}% increased Critical Strike ダメージ`,
		id: 107,
		maxPoints: 1,
		values: [ "10", "20" ],
		x: -913.285,
	...
	"Supreme Iron Maelstrom": {
		...
		description: `Dealing direct ダメージ to an enemy after swapping weapons reduces Iron Maelstrom's Cooldown by {#} second.`,
		id: 108,
		maxPoints: 1,
		values: [ "1" ],
		x: -1218.25,
	...
	"Wrath of the Berserker": {
		...
		description: `Cooldown: {#} seconds
Lucky Hit Chance: {#}%
Gain Berserking and Unstoppable for {#} seconds.  For the next {#} seconds, dealing direct ダメージ with Base Skills grants Berserking for {#} seconds.`,
		id: 110,
		maxPoints: 1,
		values: [ "60", "40", "5", "10", "5" ],
		x: 4.845,
	...
	"Supreme Wrath of the Berserker": {
		...
		description: `While Wrath of the Berserker is active, every {#} Fury you spend increases Berserk's ダメージ bonus by x{#}%.`,
		id: 111,
		maxPoints: 1,
		values: [ "50", "25" ],
		x: 3.835,
	...
	"Wallop": {
		...
		description: `Your Skills using Bludgeoning weapons deal x{#}% increased ダメージ if the enemy is Stunned or Vulnerable.`,
		id: 116,
		maxPoints: 3,
		values: [ "{5/10/15}" ],
		x: 577.06,
	...
	"Brute Force": {
		...
		description: `Your Overpowers deal x{#}% increased ダメージ when using a Two-Handed weapon.`,
		id: 117,
		maxPoints: 3,
		values: [ "{15/30/45}" ],
		x: 857.583,
	...
	"Heavy Handed": {
		...
		description: `While using Two-Handed weapons you deal x{#}% increased Critical Strike ダメージ.`,
		id: 118,
		maxPoints: 3,
		values: [ "{5/10/15}" ],
		x: 582.895,
...
barbarianData["Capstone"] = {
	"Unconstrained": {
		connections: [ "Capstone" ],
		description: `Increase Berserk's maximum duration by {#} seconds and increase its ダメージ bonus by +{#}%.`,
		id: 120,
		maxPoints: 1,
		values: [ "5", "25" ],
		x: -667.071,
	...
	"Gushing Wounds": {
		connections: [ "Capstone" ],
		description: `When causing an enemy to Bleed, you have a chance equal to your Critical Strike Chance to increase the Bleed amount by {#}% of your Critical Strike ダメージ bonus.

Overpowering a Bleeding enemy creates an explosion that inflicts {#}% Bleeding ダメージ over {#} seconds.`,
		id: 121,
		maxPoints: 1,
		values: [ "100", "11", "5" ],
		x: 666.365,
	...
	"Unbridled Rage": {
		connections: [ "Capstone" ],
		description: `Core Skills deal x{#}% increased ダメージ, but cost x{#}% more Fury.`,
		id: 122,
		maxPoints: 1,
		values: [ "135", "100" ],
		x: 415.642,
	...
	"Walking Arsenal": {
		connections: [ "Capstone" ],
		description: `Dealing direct ダメージ with a Two-Handed Bludgeoning, Two-Handed Slashing, or Dual Wielded weapons grants x{#}% increased ダメージ for {#} seconds.

While all three ダメージ bonuses are active, you gain an additional x{#}% increased ダメージ.`,
		id: 123,
		maxPoints: 1,
		values: [ "10", "6", "15" ],
		x: -425.632,
